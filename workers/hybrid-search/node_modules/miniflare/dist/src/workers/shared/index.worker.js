...
async function fetchSingleRange(fetcher, url, range) {
  ...
  if (assert(res.ok && res.body !== null), range !== void 0 && res.status !== 206) {
    let contentLength = parseInt(res.headers.get("Content-Length") ?? "NaN");
...
}, LogLevel = /* @__PURE__ */ ((LogLevel2) => (LogLevel2[LogLevel2.NONE = 0] = "NONE", LogLevel2[LogLevel2.ERROR = 1] = "ERROR", LogLevel2[LogLevel2.WARN = 2] = "WARN", LogLevel2[LogLevel2.INFO = 3] = "INFO", LogLevel2[LogLevel2.DEBUG = 4] = "DEBUG", LogLevel2[LogLevel2.VERBOSE = 5] = "VERBOSE", LogLevel2))(LogLevel || {});
...
var DeferredPromise = class extends Promise {
  ...
  constructor(executor = () => {
    ...
    super((resolve, reject) => (promiseResolve = resolve, promiseReject = reject, executor(resolve, reject))), assert6(promiseResolve), assert6(promiseReject), this.resolve = promiseResolve, this.reject = promiseReject;
  }
}, Mutex = class {
  locked = !1;
  resolveQueue = [];

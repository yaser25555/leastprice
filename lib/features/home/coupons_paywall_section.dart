...
class CouponsPaywallSection extends StatelessWidget {
  ...
  static List<_PaywallStore> get _featuredStores => [
        ...
        _PaywallStore('لاڤين عباية', Color(0xFFAD1457), AppPalette.pureWhite),
        _PaywallStore('عالم ايوا', Color(0xFF00695C), AppPalette.pureWhite),
        _PaywallStore('قمة زاوية الشفاء', Color(0xFFB8860B), AppPalette.pureWhite),
        _PaywallStore('بازل', Color(0xFF6A1B9A), AppPalette.pureWhite),
        _PaywallStore('أضحية', Color(0xFF2E7D32), AppPalette.pureWhite),
        _PaywallStore('جوهره أونلاين', Color(0xFFB8860B), AppPalette.pureWhite),
        _PaywallStore('knoadress', Color(0xFFD4A5C4), AppPalette.pureWhite),
        _PaywallStore('بوتيك بيبي بيوتي', Color(0xFFE91E63), AppPalette.pureWhite),
        _PaywallStore('جولينا', Color(0xFF9C27B0), AppPalette.pureWhite),
        _PaywallStore('كيونكس', Color(0xFF1565C0), AppPalette.pureWhite),
        _PaywallStore('بياك', Color(0xFF6D4C41), AppPalette.pureWhite),
        _PaywallStore('أصل الفخامة', Color(0xFFD4AF37), AppPalette.pureWhite),
        _PaywallStore('روزيتا', Color(0xFFD81B60), AppPalette.pureWhite),
        _PaywallStore('فور يو', Color(0xFFEC407A), AppPalette.pureWhite),
        _PaywallStore('Cuupac', Color(0xFF26A69A), AppPalette.pureWhite),
        _PaywallStore('جي بي اورجانيك', Color(0xFF4CAF50), AppPalette.pureWhite),
        _PaywallStore('العيسائي للإلكترونيات', Color(0xFF1565C0), AppPalette.pureWhite),
        _PaywallStore('تطريز', Color(0xFF7B1FA2), AppPalette.pureWhite),
        _PaywallStore('اورسلا كير', Color(0xFFE91E63), AppPalette.pureWhite),
        _PaywallStore('بارسا كافيه', Color(0xFF5D4037), AppPalette.pureWhite),
        _PaywallStore('شروق ناي', Color(0xFF9C27B0), AppPalette.pureWhite),
        _PaywallStore('LiftGlo', Color(0xFF00BCD4), AppPalette.pureWhite),
        _PaywallStore('شموخ', Color(0xFFE91E63), AppPalette.pureWhite),
        _PaywallStore('ستار بلاك', Color(0xFF212121), AppPalette.pureWhite),
        _PaywallStore('دنيا الاسعار', Color(0xFF00897B), AppPalette.pureWhite),
        _PaywallStore('Queen Arab', Color(0xFFFF6F00), AppPalette.pureWhite),
        _PaywallStore('العيسائي للأطفال', Color(0xFF42A5F5), AppPalette.pureWhite),
        _PaywallStore('قولدن فلورا', Color(0xFFD4AF37), AppPalette.pureWhite),
        _PaywallStore('زاوية التجميل', Color(0xFFE91E63), AppPalette.pureWhite),
        _PaywallStore('فانيلا', Color(0xFF7B1FA2), AppPalette.pureWhite),
        _PaywallStore('العجائب', Color(0xFF2E7D32), AppPalette.pureWhite),
        _PaywallStore('VION', Color(0xFFE91E63), AppPalette.pureWhite),
      ];

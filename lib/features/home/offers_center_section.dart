...
class OffersCenterSection extends StatefulWidget {
  const OffersCenterSection({super.key});

  @override
  State<OffersCenterSection> createState() => _OffersCenterSectionState();
}

class _OffersCenterSectionState extends State<OffersCenterSection> {
  String _searchQuery = '';
  ...
  List<Map<String, dynamic>> get _filteredStores {
    return _allStores.where((store) {
      ...
      if (_selectedCategory == 'women') return ['fashion', 'beauty', 'jewelry', 'shoes'].contains(cat);
      if (_selectedCategory == 'electronics') return cat == 'electronics';
      if (_selectedCategory == 'shopping') return ['amazon', 'noon', 'supermarkets'].contains(cat) || store['source'] == 'main';
      return false;
    }).toList();
  }

...
class Coupon {
  ...
  static final List<Coupon> mockData = [
    ...
    Coupon(
      ...
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون أضحية الحصري', 'Exclusive Odhia coupon'),
      description: tr(
        'كود خصم على الأضاحي والعقيقة.',
        'Discount code for Qurbani and Aqiqah.',
      ),
    ),
    Coupon(
      id: 'coupon-jawhara',
      code: 'F-BEH9G',
      storeId: 'jawhara',
      storeName: 'جوهره أونلاين',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون جوهره الحصري', 'Exclusive Jawhara coupon'),
      description: tr(
        'كود خصم على الأجهزة المنزلية والأثاث والديكور.',
        'Discount code for home appliances, furniture and decor.',
      ),
    ),
    Coupon(
      id: 'coupon-jolina',
      ...
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون جولينا الحصري', 'Exclusive Jolina coupon'),
      description: tr(
        'كود خصم على الفساتين والأزياء النسائية.',
        'Discount code for dresses and women\'s fashion.',
      ),
    ),
    Coupon(
      id: 'coupon-beyyak',
      ...
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون بياك الحصري', 'Exclusive Beyyak coupon'),
      description: tr(
        'كود خصم على القهوة المختصة وملحقاتها.',
        'Discount code for specialty coffee and accessories.',
      ),
    ),
    Coupon(
      id: 'coupon-rozitaa',
      ...
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون روزيتا الحصري', 'Exclusive Rozitaa coupon'),
      description: tr(
        'كود خصم على الورود والهدايا.',
        'Discount code for flowers and gifts.',
      ),
    ),
    Coupon(
      id: 'coupon-foryou4laser',
      code: 'F-GMF4S',
      storeId: 'foryou4laser',
      storeName: 'فور يو',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون فور يو الحصري', 'Exclusive For You coupon'),
      description: tr(
        'كود خصم على أجهزة الليزر المنزلي والعناية بالبشرة.',
        'Discount code for home laser and skincare devices.',
      ),
    ),
    Coupon(
      id: 'coupon-cuupac',
      ...
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون Cuupac الحصري', 'Exclusive Cuupac coupon'),
      description: tr(
        'كود خصم على المكملات الغذائية والفيتامينات.',
        'Discount code for supplements and vitamins.',
      ),
    ),
    Coupon(
      id: 'coupon-jborgnic',
      code: 'F-STUTS',
      storeId: 'jborgnic',
      storeName: 'جي بي اورجانيك',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون جي بي اورجانيك الحصري', 'Exclusive JB Organic coupon'),
      description: tr(
        'كود خصم على منتجات العناية بالشعر والبشرة.',
        'Discount code for hair and skincare products.',
      ),
    ),
    Coupon(
      id: 'coupon-alesaei',
      code: 'F-RZBMM',
      storeId: 'alesaei',
      storeName: 'العيسائي للإلكترونيات',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون العيسائي الحصري', 'Exclusive Al-Esaei coupon'),
      description: tr(
        'كود خصم على الشاشات والأجهزة المنزلية.',
        'Discount code for TVs and home appliances.',
      ),
    ),
    Coupon(
      id: 'coupon-hurufsa',
      ...
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون تطريز الحصري', 'Exclusive Tatreez coupon'),
      description: tr(
        'كود خصم على التطريز والهدايا المطرزة.',
        'Discount code for embroidery and embroidered gifts.',
      ),
    ),
    Coupon(
      id: 'coupon-urslacare',
      code: 'F-YMU73',
      storeId: 'urslacare',
      storeName: 'اورسلا كير',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون اورسلا كير الحصري', 'Exclusive Ursla Care coupon'),
      description: tr(
        'كود خصم على أجهزة الليزر المنزلي.',
        'Discount code for home laser devices.',
      ),
    ...
    Coupon(
      id: 'coupon-parsacoffee',
      code: 'F-OCPTE',
      storeId: 'parsacoffee',
      storeName: 'بارسا كافيه',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون بارسا كافيه الحصري', 'Exclusive Parsa Coffee coupon'),
      description: tr(
        'كود خصم على القهوة الجنسنج ومشروبات الطاقة الطبيعية.',
        'Discount code for ginseng coffee and natural energy drinks.',
      ),
    ),
    Coupon(
      id: 'coupon-shrouqnay',
      ...
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون شروق ناي الحصري', 'Exclusive Shrouq Nay coupon'),
      description: tr(
        'كود خصم على منتجات العناية بالبشرة والعطور.',
        'Discount code for skincare and perfumes.',
      ),
    ),
    Coupon(
      id: 'coupon-liftglo',
      ...
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون LiftGlo الحصري', 'Exclusive LiftGlo coupon'),
      description: tr(
        'كود خصم على جهاز تنظيف البشرة.',
        'Discount code for the hydrafacial skin cleansing device.',
      ),
    ),
    Coupon(
      id: 'coupon-dunyaalasar',
      code: 'F-KEIFW',
      storeId: 'dunyaalasar',
      storeName: 'دنيا الاسعار',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون دنيا الاسعار الحصري', 'Exclusive Dunya Al Asar coupon'),
      description: tr(
        'كود خصم على الكماليات المنزلية والمطبخ.',
        'Discount code for home supplies and kitchen tools.',
      ),
    ),
    Coupon(
      id: 'coupon-queenarad',
      code: 'F-JYRCG',
      storeId: 'queenarad',
      storeName: 'Queen Arab',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون Queen Arab الحصري', 'Exclusive Queen Arab coupon'),
      description: tr(
        'كود خصم على شحن الكوينزات للتطبيقات.',
        'Discount code for app coins top-up.',
      ),
    ),
    Coupon(
      id: 'coupon-goldenflora',
      code: 'F-IDIES',
      storeId: 'goldenflora',
      storeName: 'قولدن فلورا',
      discountLabel: tr('خصم خاص', 'Special discount'),
      expiresAt: DateTime.now().add(const Duration(days: 60)),
      title: tr('كوبون قولدن فلورا الحصري', 'Exclusive Golden Flora coupon'),
      description: tr(
        'كود خصم على العطور الفاخرة.',
